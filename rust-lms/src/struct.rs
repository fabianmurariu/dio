...
use crate::refer::{RustPtr, SPtr, SRef, SRefMut};
...
impl<'a, P: StagedType> PointerLike for SRef<'a, P, RustPtr> {
    type Pointee = P;
}
...
impl<'a, P: StagedType, Out: StagedType + 'a> FieldRefOf<Out> for SRef<'a, P, RustPtr> {
    type Ref = SRef<'a, Out, RustPtr>;
}

impl<'a, P: StagedType, Out: StagedType + 'a> FieldRefOf<Out> for SRefMut<'a, P, RustPtr> {
    type Ref = SRefMut<'a, Out, RustPtr>;
}
