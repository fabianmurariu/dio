...
fn test_extern_fn_simple_add() {
    ...
    let test_fn = compiler.fun2("test", |_ctx, x: Var<I64Type>, y: Var<I64Type>| {
        call_extern2::<_, _, _, I64Type, I64Type, I64Type>(add_fn, x, y)
    });
...
fn test_extern_fn_simple_square() {
    ...
    let test_fn = compiler.fun1("test", |_ctx, x: Var<I64Type>| {
        call_extern1::<_, _, I64Type, I64Type>(square_fn, x)
    });
...
fn test_extern_fn_chained() {
    ...
    // Compute square(x + y)
    let test_fn = compiler.fun2("test", |_ctx, x: Var<I64Type>, y: Var<I64Type>| {
        let sum = call_extern2::<_, _, _, I64Type, I64Type, I64Type>(add_fn, x, y);
        call_extern1::<_, _, I64Type, I64Type>(square_fn, sum)
    });
...
fn test_extern_fn_with_internal() {
    ...
    let internal_double = compiler.fun1("double", |_ctx, x: Var<I64Type>| add(x, x));

    let test_fn = compiler.fun2("test", |_ctx, x: Var<I64Type>, y: Var<I64Type>| {
        // double(ext_add(x, y))
        let sum = call_extern2::<_, _, _, I64Type, I64Type, I64Type>(ext_add, x, y);
...
fn test_extern_fn_sum_slice() {
    ...
    let test_fn =
        compiler.fun1("test", |_ctx, data: Var<FatSliceType<I64Type>>| {
            call_extern1::<_, _, FatSliceType<I64Type>, I64Type>(sum_fn, data)
        });
...
fn test_extern_fn_slice_len() {
    ...
    let test_fn =
        compiler.fun1("test", |_ctx, data: Var<FatSliceType<I64Type>>| {
            call_extern1::<_, _, FatSliceType<I64Type>, I64Type>(len_fn, data)
        });
